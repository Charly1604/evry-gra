...
```
    ...
    ## # A tibble: 191 x 4
    ##    `TRADE DATE`        `NASDAQOMX/NQFRT~ `NASDAQOMX/NQBRI~ `ML/TRI/BAMLCC0~
    ##    <dttm>                          <dbl>             <dbl>            <dbl>
...
```
    ...
    ##  Median : 0.009504           Median : 0.01308             
    ##  Mean   : 0.007776           Mean   : 0.01197             
    ##  3rd Qu.: 0.045985           3rd Qu.: 0.05105             
...
There are 154 learning observations and 37 backtest observations. My
...
constructed on the learning sample is equal to 4.73%.
...
constructed on the learning sample is equal to 5.76%.
...
is equal to 7.37%. BL approach mitigates the return of this portfolio by
